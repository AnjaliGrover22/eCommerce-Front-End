...
const NewCategoryModal = ({ closeModal, cats, setCats }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setCats((prevCats) => [...prevCats, newCategory]);
    } catch (error) {
                ...
                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      Here you can create a new category, that you can add
                      products from "Create Product".
                    </p>
                  </div>
                    ...
                    <div className="flex flex-col mr-3">
                      <div className="mt-4">
                        ...
                        <input
                          ...
                          name="name"
                          id="name"
                          placeholder="Type name of your category..."
                          value={name}
